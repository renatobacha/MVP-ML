...
Módulo de Regressão: Prevê a quantidade de gols que cada time fará em uma partida específica, analisando o histórico de gols marcados e sofridos de cada seleção.
